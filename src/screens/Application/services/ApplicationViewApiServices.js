...
const ApplicationViewApiServices = {
  ...
  applicationTaskApiServices: {
    ...
    updateTask: (id, data) =>
      ApiService.putData(`${APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_TASK.SAVE_NEW_TASK}${id}`, data),
    getApplicationTaskDetailById: id =>
      ApiService.getData(`${APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_TASK.GET_APPLICATION_TASK_DETAIL}${id}`),
    deleteTask: taskId =>
  ...
  applicationModulesApiServices: {
    ...
    getDocumentTypeListData: params =>
      ApiService.getData(APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_MODULES.GET_DOCUMENT_TYPE_LIST_URL, { params }),
  ...
  applicationReportsApiServices: {
    getDebtorsReportListData: id =>
      ApiService.getData(`${APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_REPORTS.APPLICATION_REPORTS_LIST}${id}`),
  ...
  applicationAlertsApiServices: {
    getApplicationAlertsListData: id =>
      ApiService.getData(`${APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_ALERTS.APPLICATION_ALERTS_LIST}${id}`),
    getApplicationAlertsDetails: id =>
      ApiService.getData(`${APPLICATION_URLS.VIEW_APPLICATION.APPLICATION_ALERTS.ALERTS_DETAILS}${id}`),
  },
};
